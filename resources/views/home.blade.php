...
@section('content')
  ...
  <div class="mb-3 d-flex justify-content-center">
    <div>
      <h2 class="mb-1 mt-4 text-center">Програма</h2>
      <strong>„Конкурентоспособност и иновации в предприятията"</strong>
    </div>
  </div>

  <div class="row mb-3">
    <div class="col-4">
      <img src="assets/img/ssss1.jpg" class="img-fluid" alt="">
    </div>
    <div class="col-4"></div>                              
    <div class="col-4">
      <img src="assets/img/sss2.png" class="img-fluid" alt="">
    </div>
  </div>

  <strong style="text-align: justify; display: block;">
    На 02.07.2025 г. Маджестик Клуб ООД стартира изпълнението на проект „Подкрепа за семейно предприятие за подобряване на
